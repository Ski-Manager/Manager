...
(function () {
    ...
    /* Restore persisted state on page load.
       On mobile (< 768 px) default to collapsed so the full content width is available. */
    var saved;
    var mobileDefault = (window.innerWidth < 768) ? 'collapsed' : 'expanded';
    try { saved = localStorage.getItem(SIDEBAR_KEY) || mobileDefault; } catch (e) { saved = mobileDefault; }
