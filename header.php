...
#sidebar-wrapper{width:65px;margin-left:-65px;float:left;position:relative;top:-50px;overflow:hidden}
...
<!-- CrazyGames SDK v3 — loaded in <head> as required by the platform -->
