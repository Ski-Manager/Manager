...
/**
 * Snowmaking_upgrade_model
 *
 * Handles database operations for the Snowmaking Upgrade Research Tree.
 */
class Snowmaking_upgrade_model extends CI_Model {

    public function get_all_research_DB($id_resort) {
        return $this->db
            ->select('upgrade_key, status, started_at, finish_at')
            ->from('game_snowmaking_upgrade_research')
    ...
    public function start_research_DB($id_resort, $upgrade_key, $duration_days) {
        ...
        return $this->db->insert('game_snowmaking_upgrade_research', [
            'id_resort'   => $id_resort,
    ...
    public function complete_overdue_research_DB() {
        ...
        $this->db->update('game_snowmaking_upgrade_research');
